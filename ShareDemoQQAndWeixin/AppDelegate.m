...
- (void)addShare{
     ...
     */
    [ShareSDK registerApp:@"14c8bc895fdd8"   //Share AppID
...
//                 break;
             ...
             case SSDKPlatformTypeWechat:
                 [appInfo SSDKSetupWeChatByAppId:@"wxa316aa6fc6512be8"
                                       appSecret:@"b31f6e6492730c133c0c8507ff7504b0"];
                 break;
             case SSDKPlatformTypeQQ:
                 [appInfo SSDKSetupQQByAppId:@"1105435197"
                                      appKey:@"EnCosWdIgnEc5I1v"
                                    authType:SSDKAuthTypeBoth];
                 break;
